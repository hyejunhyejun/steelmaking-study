...
QUESTION_TEXT_FIXES = {
    ...
    "t13-63": ("용선을 주선기로 냉선 제조하는 목적과 "
               "개공기 타입 2가지·개공기 도구 2가지를 쓰시오."),
...
ANSWER_UNIFY = {
    ...
    # 108번(노내 부착물 생성 시) = 기출 24-1-13과 같은 답
    "t29-109": [{"label": "현상", "answers": _DEPOSIT_SYMPTOM},
    ...
    "t29-113": [
        {"label": "정의", "answers": [
            "노 단면 일부만 통기저항이 작아 가스가 집중 통과하는 상태"]},
        {"label": "원인 3가지", "answers": [
            "① 특정풍구 미환원광석 강하",
            "② 송풍압 이상저하",
            "③ 노정가스 CO/CO₂비 증대",
            "(④ 출선구·출재구 위치에서 선철·슬래그 성분 급변)"]},
    ],
    # ===== 열풍로 =====
    ...
    # 주선기 냉선 제조 목적·개공기 타입
    "22-1-13": _COLD_PIG,
    # 62번만 개공기 도구를 더 묻는다(기출 22-1-13에는 없는 소문제)
    "t13-63": _COLD_PIG + [
        {"label": "개공기 도구 2가지", "answers": [
            "① 에어해머", "② 에어모터드릴", "③ 산소절단기"]}],
    # Lap 출선 (오탈자 '대량도' → '대탕도')
